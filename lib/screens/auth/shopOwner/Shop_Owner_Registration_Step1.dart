                              ...
                              Container(
                                ...
                                child: const Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 8),
                                    Text("• Minimum 6 characters", style: TextStyle(fontSize: 14)),
                                    Text("• At least 1 uppercase letter (A–Z)", style: TextStyle(fontSize: 14)),
                                    Text("• At least 1 lowercase letter (a–z)", style: TextStyle(fontSize: 14)),
                                    Text("• At least 1 number (0–9)", style: TextStyle(fontSize: 14)),
                                  ],
                                ),
                              ),
